    ...
    >
      ...
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form @submit.prevent="doLogin" class="space-y-4 md:space-y-6">
            <div>
              <label
                for="email"
            ...
            <div class="flex items-center justify-between">
              ...
              <RouterLink
                ...
                class="text-sm font-medium cursor-pointer text-primary-600 hover:underline dark:text-primary-500"
...
async function doLogin() {
  const response = await execute(form.value)
